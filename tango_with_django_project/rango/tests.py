...
class Chapter5ModelTests(TestCase):
    ...
    def setUp(self):
        ...
        Page.objects.get_or_create(category=category_py[0], title='Tango with Django',
                                   url='https://www.tangowithdjango.com', views=156)
...
class Chapter5PopulationScriptTests(TestCase):
    ...
    def test_pages(self):
        ...
        """
        details = {'Python': ['Official Python Tutorial', 'How to Think like a Computer Scientist',
    ...
    def test_counts(self):
        ...
        """
        details = {'Python': {'views': 128, 'likes': 64}, 'Django': {'views': 64, 'likes': 32},
