...
def create_user_object():
    ...
    """
    user = User.objects.get_or_create(username='testuser', first_name='Test', last_name='User', email='test@test.com')[
        0]
...
class Chapter9ModelTests(TestCase):
    ...
    def test_userprofile_class(self):
        ...
        expected_attributes = {'website': 'www.google.com', 'picture': tempfile.NamedTemporaryFile(suffix=".jpg").name,
            'user': create_user_object(), }

        expected_types = {'website': models.fields.URLField, 'picture': models.fields.files.ImageField,
...
class Chapter9RegisterFormClassTests(TestCase):
    ...
    def test_user_form(self):
        ...
        expected_fields = {'username': django_fields.CharField, 'email': django_fields.EmailField,
    ...
    def test_user_profile_form(self):
        ...
        expected_fields = {'website': django_fields.URLField, 'picture': django_fields.ImageField, }
