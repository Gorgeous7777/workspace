...
class Chapter7FormClassTests(TestCase):
    ...
    def test_category_form_class(self):
        ...
        expected_fields = {'name': django_fields.CharField, 'views': django_fields.IntegerField,
            'likes': django_fields.IntegerField, 'slug': django_fields.CharField, }
...
class Chapter7CategoryFormAncillaryTests(TestCase):
    ...
    def test_add_category_functionality(self):
        ...
        """
        self.client.post(reverse('rango:add_category'), {'name': 'Erlang', 'views': 0, 'likes': 0})
    ...
    def test_category_exists(self):
        ...
        response = self.client.post(reverse('rango:add_category'), {'name': 'Python', 'views': 0, 'likes': 0})
...
class Chapter7PageFormClassTests(TestCase):
    ...
    def test_page_form_class(self):
        ...
        expected_fields = {'title': django_fields.CharField, 'url': django_fields.URLField,
